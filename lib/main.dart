import 'package:covid_restapi_app/dashboard/dashboard_screen.dart';
import 'package:covid_restapi_app/services/api.dart';
import 'package:covid_restapi_app/services/api_service.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Dashboard Covid 2019',
      theme: ThemeData(
        primarySwatch: Colors.blue,
      ),
      home: DashBoardScreen(), //MyHomePage(title: 'Flutter Demo Home Page')
    );
  }
}
